...
class Devineni2015(CanagliflozinSimulationExperiment):
    """Simulation experiment of Devineni2015."""

    info = {"can300": "CAN300", "can300_met2000": "CAN300_MET2000"}
    ...
    def fit_mappings(self) -> Dict[str, FitMapping]:
        ...
        for sim, group in self.info.items():
            ...
            coadministration = Coadministration.METFORMIN if "MET2000" in group else Coadministration.NONE
            ...
            mappings[f"task_po_{sim}"] = FitMapping(
                ...
                observable=FitData(
                    self, task=f"task_po_{sim}_multi", xid="time", yid="[Cve_can]",
                ),
    ...
    def figures(self) -> Dict[str, Figure]:
        ...
        for sim, group in self.info.items():
            ...
            label = "300 mg PO" if group == "CAN300" else "300 mg PO + MET"
...
if __name__ == "__main__":
    run_experiments(Devineni2015, output_dir=Devineni2015.__name__)