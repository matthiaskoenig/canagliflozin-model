...
from pkdb_models.models.canagliflozin.models.model_kidney import model_kidney
from pkdb_models.models.canagliflozin.models.model_liver import model_liver
from pkdb_models.models.canagliflozin.models.model_intestine import model_intestine
from pkdb_models.models.canagliflozin.models.model_body import model_body
...
def create_models(
    ...
    results: Dict[str, Dict[str, Any]] = {
        ...
        "model_figure": {
            "path": MODEL_BASE_PATH.parent / "figures" / "canagliflozin_model.png",
            "entry": ManifestEntry(
                location=f"./figures/canagliflozin_model.png",
